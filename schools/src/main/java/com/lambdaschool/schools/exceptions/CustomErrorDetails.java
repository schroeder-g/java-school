...
public class CustomErrorDetails extends DefaultErrorAttributes
{
            ...
            boolean includeStackTrace)
    {
      ...
      errorDetails.put("developerMessage", errorAttributes.get("path"));
        // provide a list of ALL invalid fields input by client.
        // webRequest contains actual err messages that got generated.
